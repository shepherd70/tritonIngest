...
Read tabular sources as all-text so fragile notation survives; coerce
mixed date encodings.
...
Recover the real header row and strip blank rows / spacer columns from
dirty workbooks.
...
Detect long vs wide layout and melt wide to long.
...
- [`is_value_like()`](https://shepherd70.github.io/tritonIngest/reference/is_value_like.md)
  : Does a character vector look numeric-ish (allowing non-detect
  notation)?
